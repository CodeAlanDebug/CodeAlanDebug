...
**Development**  
[![Development](https://skillicons.dev/icons?i=js,ts,react,vue,nuxtjs,astro,vite,tailwind,nodejs,fastapi,spring,java,go,php,kafka,cs&perline=8)](https://skillicons.dev)

**Cloud & Infrastructure**  
[![Cloud & Infrastructure](https://skillicons.dev/icons?i=aws,azure,gcp,cloudflare,workers,docker,kubernetes,terraform,nginx,netlify,vercel,gitlab,ubuntu,kali,ipfs&perline=8)](https://skillicons.dev)

**Data, Platforms & Tools**  
[![Data, Platforms & Tools](https://skillicons.dev/icons?i=mysql,postgres,sqlite,supabase,planetscale,py,r,androidstudio,apple,arduino,kotlin,wordpress,figma,vscode,pnpm,obsidian,notion&perline=8)](https://skillicons.dev)
